...
function gameReadyMsg() {
  const background = new Background();
  background.drawImg(context, canvasBackground);
  background.draw(context);
  ...
  context.font = '48px PressStart2P';
  context.fillText('READY', (canvas.width / 2) - 80, (canvas.height / 2));
  context.font = '20px PressStart2P';
  context.fillText('(Press - SPACE - to Fly)', (canvas.width / 2) - 100, (canvas.height / 2) + 40);
}
